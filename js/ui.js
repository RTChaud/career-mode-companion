...
const UI = (() => {
  ...
  const el = {
    ...
    squadDepthSubview: document.getElementById('squadDepthSubview'),
    squadDepthFormationLabel: document.getElementById('squadDepthFormationLabel'),
    squadDepthManageTacticsBtn: document.getElementById('squadDepthManageTacticsBtn'),
    squadDepthDisplayModeControl: document.getElementById('squadDepthDisplayModeControl'),
    squadDepthPitch: document.getElementById('squadDepthPitch'),
    playersView: document.getElementById('playersView'),
    roleFinderSearchInput: document.getElementById('roleFinderSearchInput'),
    roleFinderClearSearchBtn: document.getElementById('roleFinderClearSearchBtn'),
    roleFinderPlaystyleChips: document.getElementById('roleFinderPlaystyleChips'),
    roleFinderClearAllBtn: document.getElementById('roleFinderClearAllBtn'),
    roleFinderResults: document.getElementById('roleFinderResults'),
    roleFinderEmptyState: document.getElementById('roleFinderEmptyState'),
    ...
    headerCrestBtn: document.getElementById('headerCrestBtn'),
    linksMenuBackdrop: document.getElementById('linksMenuBackdrop'),
    linksMenuDialog: document.getElementById('linksMenuDialog'),
    linksMenuCloseBtn: document.getElementById('linksMenuCloseBtn'),
